...
void process(void)
{
	...
	else if (keyCode == 'd' && hx < (screen_width() - 2) - sprite_width(hero))
	{
		sprite_move(hero, +1, 0);
	}
	// (j) Move hero up according to specification.
	else if (keyCode == 'w' && hy < (screen_height() - 2) - sprite_width(hero))
	{
		sprite_move(hero, 0, -1);
	}
	// (k) Move hero down according to specification.
	else if (keyCode == 's' && hy < (screen_height() - 2) - sprite_width(hero))
	{
		sprite_move(hero, 0, +1);
	}
