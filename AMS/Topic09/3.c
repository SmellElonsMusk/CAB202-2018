...
void setup(void)
{
	...
	CLEAR_BIT(DDRB, 1);
	//	(e) Display your student number, "n9950095", with nominal
	//	top-left corner at screen location (24,25).
	draw_string(24, 25, "n9950095", FG_COLOUR);
...
ISR(TIMER0_OVF_vect)
{
	...
	//			to be open at least 3 in a row, so store 0 in switch_closed,
